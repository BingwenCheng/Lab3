...
public class DialGUI implements Runnable,MyObserver {
	...
	Dial dialr = new Dial(this);
	Dial dialg = new Dial(this);
	Dial dialb = new Dial(this);
...
//		dialr.notifyObservers();
		dialg.registerObserver(this);
//		dialg.notifyObservers();
		dialb.registerObserver(this);
//		dialb.notifyObservers();
...
//		dialg = new Dial(this);
//		dialb = new Dial(this);
		dialr.color = Color.red;
		dialg.color = Color.green;
		dialb.color = Color.blue;
